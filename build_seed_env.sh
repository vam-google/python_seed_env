...
# MaxText commit
curl https://raw.githubusercontent.com/jax-ml/jax/d3f08713bc8cc2700851c61c55d7d7dde1de5a02/build/requirements_lock_3_11.txt -O
...
# ---------------------------------
uv add --managed-python --no-build --no-sync --resolution=highest -r requirements_lock_3_11.txt
...
uv export --managed-python --locked --no-hashes --no-annotate --resolution=highest --output-file=maxtext_requirements_lock_3_11.txt
python3 lock_to_lower_bound_project.py maxtext_requirements_lock_3_11.txt pyproject.toml
rm uv.lock
uv lock --managed-python --resolution=lowest
uv export --managed-python --locked --no-hashes --no-annotate --resolution=lowest --output-file=maxtext_requirements_lock_3_11.txt

# Congrats, you've done it:
#   - maxtext_requirements_lock_3_11.txt is your well-defined reproducible python
...
#       uv export --managed-python --locked --no-hashes --no-annotate --resolution=lowest --output-file=maxtext_requirements_lock_3_11.txt # regenerates lock.txt
