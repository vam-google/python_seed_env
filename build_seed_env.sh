...
# MaxText commit
curl https://raw.githubusercontent.com/jax-ml/jax/c09b1bb763d846a694f919e5a5adda9575ce66d6/build/requirements_lock_3_10.txt -O
...
# ---------------------------------
uv add --managed-python --no-build --no-sync --resolution=highest -r requirements_lock_3_10.txt
...
uv export --managed-python --locked --no-hashes --no-annotate --resolution=highest --output-file=./tpu_seed/python_3_10/maxtext_requirements_lock_3_10.txt
python3 lock_to_lower_bound_project.py ./tpu_seed/python_3_10/maxtext_requirements_lock_3_10.txt pyproject.toml
rm uv.lock
uv lock --managed-python --resolution=lowest
uv export --managed-python --locked --no-hashes --no-annotate --resolution=lowest --output-file=./tpu_seed/python_3_10/maxtext_requirements_lock_3_10.txt

# Congrats, you've done it:
#   - maxtext_requirements_lock_3_10.txt is your well-defined reproducible python
...
#       uv export --managed-python --locked --no-hashes --no-annotate --resolution=lowest --output-file=maxtext_requirements_lock_3_10.txt # regenerates lock.txt
